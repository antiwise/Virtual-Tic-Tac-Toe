...
:: Android packaging
set AND_CERT_NAME="Virtual Tic Tac Toe"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\VirtualTicTacToe.p12
...
set IOS_PROVISION=cert\VirtualTicTacToe.mobileprovision
...
set APP_ID=air.VirtualTicTacToe

:: Output packages
set DIST_PATH=dist
set DIST_NAME=VirtualTicTacToe
